...
export default function ChapterCard({
  ...
  return (
    <div className="bg-bg-secondary rounded-lg shadow-md p-4 border border-border-default flex flex-col justify-between transition-transform hover:scale-[1.02] hover:shadow-lg">
      <div>
        <h3 className="text-lg font-semibold mb-2 text-white">Chapter {chapterNumber}</h3>
        <p className="text-sm text-gray-400 mb-1">
          {totalPages > 0 ? `${totalPages} pages` : 'No pages'}
        </p>
      ...
      <div className="flex flex-col sm:flex-row gap-2 mt-auto pt-3 border-t border-border-default">
        <Link
